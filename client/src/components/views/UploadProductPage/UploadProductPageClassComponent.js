...
export class UploadProductPage extends Component {
    ...
    handleChangeFoods = (event) => {
        this.setState({ foods: event.currentTarget.value })
    }
    ...
    onSubmit = (event) => {
        ...
        if (!this.state.title || !this.state.description ||
            !this.state.foods || !this.state.images
            || !this.state.price) {
        ...
        return (
            ...
            <Form onSubmit={this.onSubmit}>
               ...
               <FileUpload refreshFunction={this.updateFiles} />
                ...
                />
                <br /><br />
                <select onChange={this.handleChangeFoods}>
                    {Foods.map(item => (
